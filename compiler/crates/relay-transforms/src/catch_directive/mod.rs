 ...
 */
 ...
 lazy_static! {
     ...
     pub static ref RESULT_ACTION: StringKey = "RESULT".intern();
     static ref NULL_ACTION: StringKey = "NULL".intern();
 ...
 impl Into<StringKey> for CatchTo {
     fn into(self) -> StringKey {
         match self {
             CatchTo::Result => *RESULT_ACTION,
             CatchTo::Null => *NULL_ACTION,
         }
     }
 }
 ...
 impl From<StringKey> for CatchTo {
     fn from(to: StringKey) -> Self {
         match to {
             _ if to == *RESULT_ACTION => Self::Result,
             _ if to == *NULL_ACTION => Self::Null,
